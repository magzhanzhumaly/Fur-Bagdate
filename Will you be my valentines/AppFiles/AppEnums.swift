...
enum NoMessages {
    ...
    case lastchance
    case reallyno
    case youmightregretthis
    case haveaheart
    case bethoughtful
    case dontbesocold
    case changeofheart
    case tryreconsidering
    case isthatyourfinalanswer
    case yourebreakingmyheart
    ...
    var str: String {
        ...
        case .haveaheart:
            return "Have a heart!"
        case .bethoughtful:
            return "Be thoughtful!"
        case .dontbesocold:
            return "Don't be so cold"
        case .changeofheart:
            return "Change of heart?"
        case .tryreconsidering:
            return "Try reconsidering"
        case .isthatyourfinalanswer:
            return "Is that your final answer?"
        case .yourebreakingmyheart:
            return "You're breaking my heart"
        }
    }
    
    static var allCases: [NoMessages] {
        return [.podumaizanovo, .podumaihoroshenko, .netoropis, .choosewisely, .mimo, .nublin, .areyousure, .lastchance, .reallyno, .youmightregretthis, .haveaheart, .bethoughtful, .dontbesocold, .changeofheart, .tryreconsidering, .isthatyourfinalanswer, .yourebreakingmyheart]
